...
return [
    ...
    'project1_title' => 'Agregador de Cervejarias e Cervejas',
    'project1_description' => 'Neste projeto, criei um catálogo/agregador de cervejarias e cervejas. Para criar novas entradas, é necessário estar registrado. Além disso, adicionei um mapa interativo com Leaflet que marca a localização do bar no mapa com base nas coordenadas adicionadas no modo de criação de entrada. Na página inicial (HOME), para torná-la mais divertida, adicionei um contador de cervejas que aumenta cada vez que clicamos em uma cerveja adicional e altera a mensagem de acordo com o número de cervejas.',

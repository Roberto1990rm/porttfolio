<x-layout>
    ...
    <div class="container">
        <h1 style="margin-bottom: 30px; margin-top: 30px;">Mis Proyectos</h1>
        <div class="row">
            <div class="col-md-4">
                <div class="card" style="background-image: url('{{ asset('images/proyecto1.jpg') }}'); background-size: cover;">
                    <div class="card-body">
                        <h5 class="card-title">Agregador cervecerías y cervezas</h5>

                        <div class="scroll-box">
                            <p style="color: rgb(7, 4, 4);" class="card-text">
